...
const entitlement = new GraphQLObjectType({
  name: 'Entitlement',
  description : 'An entitlement of an application, which could be assigned to an account.',
  fields: () => ({
    id: globalIdField('Entitlement', (obj, context, info) => obj.undefined),
    name: {
      type: GraphQLString,
...
const EntitlementConnection = connectionDefinitions({name: 'Entitlement', nodeType: entitlement});
...
const account = new GraphQLObjectType({
  ...
  fields: () => ({
    id: globalIdField('Account', (obj, context, info) => obj.undefined),
    account_id: {
      type: GraphQLString,
...
const identity = new GraphQLObjectType({
  name: 'Identity',
  description : '',
  fields: () => ({
    id: globalIdField('Identity', (obj, context, info) => obj.undefined),
    identity_id: {
      type: GraphQLString,
...
const application = new GraphQLObjectType({
  ...
  fields: () => ({
    id: globalIdField('Application', (obj, context, info) => obj.undefined),
    app_id: {
      type: GraphQLString,
